...
const ServiceCard = ({icon,title,description}) => {
  return (
    <div className=" relative hover:translate-y-[-10px]  transition duration-500 ease-in-out rounded-[10px]  bg-white     flex flex-col items-center relative  overflow-hidden group">
      ...
      <span className="w-[166px] h-[166px]    bg-[#F57005]    text-white text-[62px] rounded-full flex items-end justify-center pb-4 relative translate-y-[-37%] group-hover:bg-[#4F5DE4] transition duration-300 ease-in-out ">
        {icon}
      </span>
      ...
      <div className="border-t-2 border-[#E4E4E4] w-full flex  justify-center  group-hover:bg-[#152B4A] transition duration-300 ease-in-out">
